...
from voicevox_engine.utility import ConnectBase64WavesException, connect_base64_waves ,engine_root
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=50919)
    parser.add_argument("--engine_dir", type=Path, default=(engine_root()/"LipScream_engine"))
